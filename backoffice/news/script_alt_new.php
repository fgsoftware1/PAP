<?php
    ...
    if (move_uploaded_file($_FILES["fileUpload"]["tmp_name"], "../../".$filename)) {
        // executarSQL("UPDATE noticias
        //             SET ID_Tipo_Noticia = ".$tipo_noticia.", Titulo = '".$nome."', Conteudo = '".$conteudo."', Data = '".$data."', 
        //             Autor = ".$autor.", Imagem = '".$imagem."', Ativo = ".$ativo." WHERE ID_Noticia = ".$_GET["ID"]."");
