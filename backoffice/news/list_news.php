...
<html lang="en" class="h-100">
  ...
  <body class="d-flex flex-column h-100">
    ...
    <main class="flex-shrink-0">
      <div class="container">
        <h1 class="mt-5">Listagem noticias</h1>
        <br>
        </br>
        <a href="./create_new.php">
          <button type="button" class="btn btn-primary">Inserir noticia</button>
        </a>
        <br>
        </br>
              ...
              if($result = executarSQL($query)){
                while($row = mysqli_fetch_array($result)){
                  echo "<tr>";
                    ...
                    echo "<td>
                      <a href='./create_new.php?ID=".$row["ID_Noticia"]."'>
                        <button type='button' class='btn btn-warning'>Alterar</button>
                      </a>
                      <a href='./script_del_new.php?ID=".$row["ID_Noticia"]."'>
						...
						<li class="page-item disabled"><a class="page-link" href="#" tabindex="-1">Previous</a></li>
								<?php
									...
									for($i = 0; $i <= $paginações; $i++){
										if($pagina_atual == $i + 1){
											echo "<li class='page-item active'><a class='page-link' href='list_news.php?pagina=".($i + 1)."'>".($i + 1)."</a></li>";
										}else{
											echo "<li class='page-item'><a class='page-link' href='list_news.php?pagina=".($i + 1)."'>".($i + 1)."</a></li>";
										}
									}
								?>
