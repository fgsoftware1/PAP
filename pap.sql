...
CREATE TABLE `utilizadores` (
  ...
  PRIMARY KEY (`ID`),
  KEY `FK_TipoUtilizador` (`TipoUtilizador`),
  CONSTRAINT `FK_TipoUtilizador` FOREIGN KEY (`TipoUtilizador`) REFERENCES `tipo_utilizador` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-07-14 10:21:47
