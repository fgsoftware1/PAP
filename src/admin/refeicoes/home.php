    ...
    <div class="w-full flex">
        ...
        <div class="w-full h-fit p-10 bg-cor7">
            <div class="flex justify-between w-3/4 py-6">
                <div><h1 class="text-lg font-bold">Refeições</h1></div>
                <div>
                ...
                <tbody>
                    <?php
                        ...
                        while($row = mysqli_fetch_array($data)){
                            echo "<tr class='py-4 border-b-2'><td>".ementa($row[1], $conn)."</td><td>".$row[2]."</td><td>".$row[3]."</td><td><a href='update.php?id=".$row[0]."'><span class='material-symbols-sharp align-middle'>edit</span></a><a href='delete.php?id=".$row[0]."'><span class='material-symbols-sharp align-middle ml-4'>delete</span></a></td></tr>";
                        }
                    ?>
                </tbody>
            </table>
