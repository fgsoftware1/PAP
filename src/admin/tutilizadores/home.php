                ...
                <tbody>
                    <?php
                        ...
                        while($row = mysqli_fetch_array($data)){
                            echo "<tr class='py-4 border-b-2'><td>".$row[1]."</td><td><a href='update.php'><span class='material-symbols-sharp align-middle'>edit</span></a><a href='delete.php'><span class='material-symbols-sharp align-middle ml-4'>delete</span></a></td></tr>";
                        }
                    ?>
                </tbody>
            </table>
